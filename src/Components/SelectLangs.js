...
function SelectLangs({isopen, setIsopen}) {
  ...
  const setLangs = lang => {
    ...
    AsyncStorage.setItem('langs', lang);
    setIsopen(false);
  };
  return (
    <Modal
        ...
        <View style={styles.wrap}>
          ...
          <View style={styles.selectbox}>
            <TouchableOpacity style={styles.btn} onPress={() => setLangs('ko')}>
              <Text style={selectlang === 'ko' ? styles.activetxt : styles.txt}>
                {messages.ko}
              </Text>
              <Image
                source={
                  selectlang === 'ko'
                    ? require('../assign/img/ic_check_on.png')
                    : require('../assign/img/ic_check_off.png')
                }
              />
            </TouchableOpacity>
            <TouchableOpacity style={styles.btn} onPress={() => setLangs('en')}>
              <Text style={selectlang === 'en' ? styles.activetxt : styles.txt}>
                {messages.en}
              </Text>
              <Image
                source={
